        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
            	<div class="row container">
                    ...
                    </label>Add Short Comment
                    <div class="collapse col-lg-12" id="demo">
                        <form method="post" enctype="multipart/form-data" action="{{ route('add_precomment') }}">
                    @csrf
						<div class="form-row">
						    <div class="form-group col-md-4">
						    	<input type="text" name="comment" class="form-control" placeholder="Please Enter New Comment">
						    </div>
                ...
                <table id="commentTable" class="table table-hover non-hover" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>ID</th>
...
@push('footer-script')
    ...
    <script>
         function deleteThis(val) {
            ...
            var id = val;
            var url = "{{ route('commentDelete',':id') }}";
