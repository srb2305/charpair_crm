    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <div class="col-lg-12">
                    <a href="{{ route('add_status') }}" class="btn btn-primary" style="float: right; margin-top: 10px; margin-left: 10px;">Add Status</a>
                </div>
                <table id="StatusTable" class="table table-hover non-hover" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Date</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <form>
                ...
                <div class="modal-header user-profile" style="padding-top: 5px !important; padding-bottom: 5px !important;">
                    <h3 class="">Telecaller Profile</h3>
...
@push('footer-script')
    ...
    <script>
        function getData(val) {
            var id = val;
            var url = "{{ route('telecallerDetail') }}";
        ...
        function deleteThis(val) {
            ...
            var id = val;
            var url = "{{ route('telecallerDelete',':id') }}";
            url = url.replace(':id', id);
