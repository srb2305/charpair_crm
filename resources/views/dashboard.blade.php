                        ...
                        <div class="widget widget-one">
                            ...
                            <div class="w-chart">
                                <div class="w-chart-section">
                                        <a href="{{url('admin/user')}}" class="w-title">Total User</a>
                                        <p class="w-stats">{{$total_users}}</p>
                                ...
                                <div class="w-chart-section">
                                        <a href="#" class="w-title">Total Vehicles</a>
                                        <p class="w-stats"></p>
                                    <div class="w-chart-render-one">
                                ...
                                <div class="w-chart-section">
                                        <a href="#" class="w-title">Upcoming Lifts</a>
                                        <p class="w-stats"></p>
                                    <div class="w-chart-render-one">
                                        <div id="paid-visits"></div>
                                    </div>
                                ...
                                <div class="w-chart-section">
                                        <a href="#" class="w-title">Today Create Lifts</a>
                                        <p class="w-stats"></p>
                                    <div class="w-chart-render-one">
                                        <div id="paid-visits"></div>
                                    </div>
                                ...
                                <div class="w-chart-section">
                                        <a href="#" class="w-title">Vehicle Users</a>
                                        <p class="w-stats"></p>
                                    <div class="w-chart-render-one">
                                        <div id="paid-visits"></div>
                                    </div>
                                 ...
                                 <div class="w-chart-section">
                                        <a href="#" class="w-title">Not Vehicle Users</a>
                                        <p class="w-stats"></p>
                                    <div class="w-chart-render-one">
                                        <div id="paid-visits"></div>
                                    </div>
